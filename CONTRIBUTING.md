...
To package and release the binaries, all you have to do is commit your changes to the repository. All the work will be automatically done through Travis CI, where automated tests will be run and a Docker image will be made. The created image can be found on [Docker Hub](https://hub.docker.com/r/sixonetwo/dit168/).